...
class Package(object):
    ...
    def get_command(self):
        """Get the command to install the package.
        ...
        if self.manager == "apt":
            return "apt-get install %s" % self.name
        elif self.manager == "pip":
            return "pip install %s" % self.name
        else:
            print("Unsupported or unrecognized package manager: %s" % self.manager)
            return ""
    ...
    def to_txt(self):
        ...
        -e git+https://bitbucket.org/bogeymin/python-datetime-machine/get/master.zip#egg=python-datetime-machine
