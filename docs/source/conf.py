# -*- coding: utf-8 -*-
#
# Basis HR documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../pyprojectutils'))
...
project = u'(Python) Project Utils'
...
#html_title = u'Basis HR v0.1.0-d'
...
htmlhelp_basename = 'PyProjectUtils'
...
man_pages = [
    (master_doc, 'pyprojectutils', u'(Python) Project Utils',
     [author], 1)
]
